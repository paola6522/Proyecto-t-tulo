...
from biblioteca.forms_password import CustomPasswordResetForm, CustomSetPasswordForm # Formularios personalizados para restablecimiento de contraseña
...
urlpatterns = [
    ...
    path('pendientes/', views.pendientes, name='pendientes'), # Lista de libros pendientes por leer
    path('pendientes/agregar/<int:pendiente_id>/', views.pendiente_a_biblioteca, name='pendiente_a_biblioteca'), # Mover libro pendiente a biblioteca de leídos
